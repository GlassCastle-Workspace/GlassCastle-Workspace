...
const compiled=await post('/api/v1/compile',{program:args.program||'',policy_text,structured_scope,observed_assets});
const contract=compiled.contract||compiled;
const query={};
...
const decided=Object.keys(query).length?await post('/api/v1/decide',{contract,query}):null;
const decision=decided?.decision||decided||null;
const out={
