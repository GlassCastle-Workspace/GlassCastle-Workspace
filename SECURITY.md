...
We will evaluate reproducible reports against the affected component's documented boundaries and evidence. Experimental and release-candidate software may have explicitly documented limitations; those are not automatically vulnerabilities.
...
**Security Through Visibility, Learning Through Understanding. Evidence before assertion.**