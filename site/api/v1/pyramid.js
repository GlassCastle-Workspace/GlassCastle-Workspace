const {model,runAction}=require('../../lib/pyramid-model');
...
module.exports=(req,res)=>{
  try{
    if(req.method==='GET')return send(res,200,{ok:true,...model(),actions:['model','normalize_indicator','portfolio','ukc_plan','diamond_overlay']});
